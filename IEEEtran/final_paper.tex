...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{images/pie_chart.jpg}
\captionsetup{justification=centering}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{images/pie_chart_collapsed.jpg}
\captionsetup{justification=centering}
\caption{Showing the interactive pie chart}
\label{fig:pie_chart_collapsed}
\end{figure}
